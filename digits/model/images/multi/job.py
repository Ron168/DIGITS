...
@subclass
class MultiImageModelJob(ImageModelJob):
    """
    A Job that creates an image model for a multi network
    """

    def __init__(self, **kwargs):
        super(MultiImageModelJob, self).__init__(**kwargs)
        self.pickver_job_model_image_multi = PICKLE_VERSION

    @override
    def job_type(self):
        return 'Multi Image Model'
