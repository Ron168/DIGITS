...
class MultiImageDatasetForm(ImageDatasetForm):
    """
    Defines the form used to create a new MultiImageDatasetJob
    """
    ...
    prebuilt_train_images_0 = wtforms.StringField(
        'Training Images 0',
        validators=[
    ...
    prebuilt_train_images_1 = wtforms.StringField(
        'Training Images 1',
        validators=[
            validate_required_iff(method='prebuilt'),
            validate_lmdb_path,
    ...
    prebuilt_val_images_0 = wtforms.StringField(
        'Validation Images 0',
        validators=[
            validate_lmdb_path,
        ]
    )
    prebuilt_val_images_1 = wtforms.StringField(
        'Validation Images 1',
        validators=[
            validate_lmdb_path,
        ]
    ...
    prebuilt_mean_file_0 = utils.forms.StringField(
        'Mean Image 0',
        validators=[
            validate_file_path,
        ],
    ...
    prebuilt_mean_file_1 = utils.forms.StringField(
        'Mean Image 1',
        validators=[
            validate_file_path,
        ],
