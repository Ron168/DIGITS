...
class CreateMultiDbTask(Task):
    ...
    def __init__(self, job, backend, stage, **kwargs):
        ...
        self.mean_file = None
        super(CreateMultiDbTask, self).__init__(**kwargs)
        self.pickver_task_create_multi_db = PICKLE_VERSION
    ...
    def __getstate__(self):
        state = super(CreateMultiDbTask, self).__getstate__()
    ...
    def __setstate__(self, state):
        super(CreateMultiDbTask, self).__setstate__(state)
        self.pickver_task_create_multi_db = PICKLE_VERSION

    @override
    def before_run(self):
        super(CreateMultiDbTask, self).before_run()
        # create log file
    ...
    @override
    def after_run(self):
        super(CreateMultiDbTask, self).after_run()
