...
from .forms import MultiDatasetForm
from .job import MultiDatasetJob
...
def new(extension_id):
    """
    Returns a form for a new MultiDatasetJob
    """

    form = MultiDatasetForm()
...
def show(job, related_jobs=None):
    ...
    """
    return flask.render_template('datasets/multi/show.html', job=job, related_jobs=related_jobs)


def summary(job):
    """
    Return a short HTML summary of a MultiDatasetJob
    """
    return flask.render_template('datasets/multi/summary.html', dataset=job)
